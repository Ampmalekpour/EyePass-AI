"""
image_utils.py (recognizer)
--------------------------------------------------------------------
Verbatim port of the reference image_utils.py. Image loading helpers
used by recognition_engine.py (gallery loading, warmup image, and
any future path/url/base64 image ingestion). Unchanged from the
original — no recognition behaviour depends on this file being
"improved", so it isn't.
--------------------------------------------------------------------
"""
