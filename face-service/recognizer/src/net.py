...
net.py
--------------------------------------------------------------------
AdaFace IR-50/IR-SE backbone (PyTorch), unchanged from the reference
pipeline. Used as the fallback backend when the ONNX model fails to
load — see recognition_engine.FaceRecognition._load_onnx_model /
