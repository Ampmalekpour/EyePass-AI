...
FastAPI/uvicorn — the detector and recognizer images are already large
(torch, ultralytics, onnxruntime, the base image); this avoids one more
thing that has to be present for a container healthcheck to work.
...
logger = setup_logger("facecore.health")
