#!/usr/bin/env python3
"""
hub_tools.py — look inside the face control hub from your own machine.
...
--module defaults to REDIS_MODULE, else "face".
...
BACKEND_KEYS = {"face": "face:ai:results"}
...
if __name__ == "__main__":
    ...
    ap.add_argument("--module", default=os.environ.get("REDIS_MODULE", "face"))
    ap.add_argument("--uid")
