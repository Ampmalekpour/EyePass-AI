...
Two layers:
  ...
  * PER-MODULE policy settings. Each is read as `{MODULE}_{NAME}`
    (here FACE_SATISFIED_CONF, FACE_FINALIZE_TIMEOUT_SEC, ...) and
...
# Service-wide
# ====================================================================
# This hub serves ONE module — the one it ships with (face-service/). It
# reads the same REDIS_MODULE the module's other services use, so its
# keys always match theirs.
HUB_MODULE = _env("REDIS_MODULE", "face")
