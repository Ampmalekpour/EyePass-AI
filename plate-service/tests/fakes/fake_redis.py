...
subset of the redis-py API that platecore/bus.py actually calls
(ping, get/set/incr/decr/expire/exists, hset/hget/hgetall/hdel/hkeys,
rpush/lpush/brpop/lrange/llen, pubsub/publish). Ported verbatim from
face_service's own tests/fakes/fake_redis.py — this file is entirely
generic, nothing in it is face- or plate-specific.
